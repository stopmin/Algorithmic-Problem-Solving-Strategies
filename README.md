...
2. 양도 중요하지만, 우아하게 코드를 작성하려고 노력한다.
3. 주에 **최소 3문제** 해결한다.
4. 종만북과 관련된 문제가 아니더라도 괜찮다.

**스터디 시간 규칙**
1. 페어 프로그래밍 시간에는 하나의 컴퓨터로 두 명이 번갈아가며 코드를 짠다. 또는 한 문제를 각자 같은 시간 내에 풀어본다.
2. 그 주차에 개인이 풀었던 문제에서 더 어려운 된 문제를 페어프로그래밍 문제로 선정한다.
3. 그 주에 내가 학습했던 것과 풀었던 문제에 대한 TMI를 나눈다.
